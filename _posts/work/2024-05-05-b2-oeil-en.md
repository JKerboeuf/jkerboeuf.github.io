...
- **Accessibility**-first focus, **WCAG 2.2** conformance level **AAA**
- Includes easy install and run scripts for Windows and Linux

## Technical description

It is done with [Jekyll](https://jekyllrb.com/) in **html**, **SCSS** and **JavaScript** but also **Markdown** for the contents of the pages.
