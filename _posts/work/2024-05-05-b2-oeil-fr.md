...
- Site Web semi-statique, léger et facile à alimenter
- **Conception réactive** pour une bonne expérience visuelle sur toutes les tailles d'écrans
- **Accessibilité** priorisé, niveau de conformité **WCAG 2.2 AAA**
- Comprend des scripts d'installation et d'exécution faciles pour Windows et Linux

## Description technique

Il est fait avec [Jekyll](https://jekyllrb.com/) en **HTML**, **SCSS** et **JavaScript** mais aussi du **Markdown** pour le contenu des pages.  
